...
@WebServlet("/admin/bookChange")
public class BookInfChangeServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            newBook.setBook_id(Integer.parseInt(req.getParameter("book_id")));
            ...
            bd.changeBookInfo(newBook);
            req.setAttribute("msg","书籍信息修改成功!");
            req.getRequestDispatcher("BookInfChange.jsp").forward(req,resp);
