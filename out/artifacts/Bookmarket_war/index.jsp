...
<div class="main">
    ...
    <div class="container"><!-- 主体放入左中右三个盒子 ;
        ...
        <div class="lside">
            ...
            <span class="type"><a href="book_classify.jsp?type=1">电气类图书</a></span>
            <span class="type"><a href="book_classify.jsp?type=1">文学类图书</a></span>
        </div>
        <!-- <div class="rside">
            <h2> 右边栏</h2>
            <p> 右边栏内容右边栏内容右边栏内容右边栏内容
                右边栏内容右边栏内容右边栏内容右边栏内容
                右边栏内容右边栏内容右边栏内容右边栏内容
                右边栏内容右边栏内容右边栏内容右边栏内容
            </p>
        </div> -->
